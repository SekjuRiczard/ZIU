...
export function Dashboard() {
  ...
  const stats = [
    { label: 'Wszystkie zadania', value: mockTasks.length, subtitle: 'Całkowita liczba zadań' },
    { label: 'Aktywne', value: mockTasks.filter(t => t.status === 'default').length, subtitle: 'Do wykonania' },
    { label: 'Ukończone', value: mockTasks.filter(t => t.status === 'completed').length, subtitle: 'Zakończone zadania' },
  ];
  ...
  return (
    <DashboardLayout title="Lista Zadań">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[24px] mb-[80px]">
